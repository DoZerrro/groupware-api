...
- [x] 회사변경 프로필 팝업에서 회사/부서 정보 변경시에도, 해당 회사/부서/사용자가 갖고 있는 권한에 맞는 메뉴에만 접근 가능 하도록 최종 확인.
- [x] 로그인은 간단하게 구현
...
### [@강도영](https://github.com/DoZerrro) 부서 관리 (개발자 D)
#### 부서 관리
- [x] 부서 트리
- [x] 부서 정보
- [x] 부서원 정보
...
### [@강도영](https://github.com/DoZerrro) 사원 관리 (개발자 E)
#### 부서 관리
- [x] 사원 목록
